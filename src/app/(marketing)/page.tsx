  ...
  return (
    <main>
      <section className="mx-auto grid min-h-[calc(100vh-81px)] w-full max-w-7xl gap-14 px-6 py-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:py-24">
        <div>
          <div className="inline-flex rounded-full border border-primary/20 bg-primary/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-primary">
            Lagos-first MVP rebuild
          </div>
          <h1 className="mt-8 max-w-3xl text-5xl font-semibold leading-[1.02] tracking-tight md:text-7xl">
